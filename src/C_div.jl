...
# TRSV ==========================================================================
do_trsv!(α, B, side, A::SimpleTriangular)  = BLAS.trsv!(A.uplo, A.trans, A.diag, A.blasnode, B)
do_trsv!(α, B, side, A::UniformScaling) = rmul!(B,α/A.λ)
do_trsv!(α, B, side, A::Number) = rmul!(B,α/A)
